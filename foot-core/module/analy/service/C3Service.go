...
func (this *C3Service) analyStub(v *pojo.MatchLast) (int, *entity5.AnalyResult) {
	...
	base.Log.Info(this.ModelName()+"总积分:", temp_zong_sorce, " ,总进球:", temp_zong_goal, " ,近况:", temp_jin_val_1, " ,对阵", v.MainTeamId+":"+v.GuestTeamId, ",初盘让球:", a18Bet.SPanKou, ",即时盘让球:", a18Bet.EPanKou)
