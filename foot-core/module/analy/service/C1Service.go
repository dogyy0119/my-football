...
func (this *C1Service) analyStub(v *pojo.MatchLast) (int, *entity5.AnalyResult) {
	...
	if mainLetball {
		if letBall > 0 {
			if a18Bet.EPanKou > 0 {
				tempLetball1 := math.Abs(a18Bet.EPanKou - letBall)
	...
	base.Log.Info("所属于区间:", ",对阵", v.MainTeamId+":"+v.GuestTeamId, ",计算得出让球为:", letBall, ",初盘让球:", a18Bet.SPanKou, ",即时盘让球:", a18Bet.EPanKou)
